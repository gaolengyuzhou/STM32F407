...
#define USART_RX_GPIO_CLK_ENABLE()      do{ __HAL_RCC_GPIOD_CLK_ENABLE(); }while(0)   /* 接收引脚时钟使能 */

#define USART_UX                        UART5
#define USART_UX_IRQn                   UART5_IRQn
#define USART_UX_IRQHandler             UART5_IRQHandler
#define USART_UX_CLK_ENABLE()           do{ __HAL_RCC_UART5_CLK_ENABLE(); }while(0)  /* USART5 时钟使能 */
...
#define USART_UX_CLK_ENABLE()           do{ __HAL_RCC_USART2_CLK_ENABLE(); }while(0)  /* USART5 时钟使能 */
#endif
