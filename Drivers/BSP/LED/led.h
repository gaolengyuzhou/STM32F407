...
#define R_GPIO_CLK_ENABLE()             do{ __HAL_RCC_GPIOG_CLK_ENABLE(); }while(0)             /* PF口时钟使能 */

#define G_GPIO_PORT                     GPIOG
#define G_GPIO_PIN                      GPIO_PIN_11
#define G_GPIO_CLK_ENABLE()             do{ __HAL_RCC_GPIOG_CLK_ENABLE(); }while(0)             /* PF口时钟使能 */
 
#define B_GPIO_PORT                     GPIOG
#define B_GPIO_PIN                      GPIO_PIN_12
#define B_GPIO_CLK_ENABLE()             do{ __HAL_RCC_GPIOG_CLK_ENABLE(); }while(0)             /* PF口时钟使能 */

#define GPIO_Ka_GPIO_CLK_ENABLE()       do{ __HAL_RCC_GPIOE_CLK_ENABLE(); }while(0)   /* PA口时钟使能 */
