...
extern CAN_HandleTypeDef   g_canx_handler;     /* CANx句柄 */
extern CAN_TxHeaderTypeDef g_canx_txheader;    /* 发送参数句柄 */
extern CAN_RxHeaderTypeDef g_canx_rxheader;    /* 接收参数句柄 */
/******************************************************************************************/
/* CAN 引脚 定义 */
